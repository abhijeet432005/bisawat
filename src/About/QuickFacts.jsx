...
const QuickFacts = () => {
  ...
  return (
    <section
      ref={containerRef}
      className="w-full py-16 md:py-24 px-6 md:px-12 flex justify-center"
    ...
    >
      <div className="w-[80%] flex flex-col justify-center items-center">
        ...
        >
          ...
          <span style={{ color: "#5a8a99" }} className="font-[italic-font]">
            community impact
          </span>
        </h2>
        ...
        <div className="facts-grid grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-6">
          ...
          >
            ...
            <div
              ...
              style={{
                background: "linear-gradient(to bottom, rgba(0,0,0,0.45) 0%, transparent 100%, transparent 100%)",
                opacity: 0,
              }}
            />
          ...
          <div className="flex flex-col gap-5 md:gap-6">
            <div
              ...
              style={{ background: "#16363a", minHeight: "220px" }}
            >
              <h3 className="text-white text-2xl md:text-3xl leading-tight mb-4">
                10+ Community<br />Programs
              </h3>
            ...
            <div
              className="fact-card flex-1 rounded-2xl p-7 md:p-8 flex flex-col justify-between"
              style={{ background: "#fdf3e7", minHeight: "220px" }}
            >
              <h3 className="text-2xl md:text-3xl leading-tight mb-4" style={{ color: "#0d1b2a" }}>
                12 Specialists on<br />Board
              </h3>
          ...
          >
            ...
            <div
              className="fact-overlay absolute inset-0"
              style={{
                background: "linear-gradient(to top, rgba(0,0,0,0.55) 0%, transparent 95%, transparent 100%)",
                opacity: 0,
              }}
            />
            <div className="absolute bottom-6 left-6">
              ...
              <h3 className="text-white text-2xl md:text-3xl leading-tight">Rating</h3>
            </div>
          </div>
