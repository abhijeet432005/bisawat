...
const clinics = [
  {
    ...
    image:
      "https://cdn.prod.website-files.com/6941011e592dac3331ac7edc/694ff20c591fbab7ba17de1f_Rectangle%20(5)-p-500.webp",
  },
  {
    id: 2,
    name: "Vera Clinic",
...
const PARALLAX_AMOUNT = 60; // ← px image shifts left/right for non-active cards
...
export default function FeaturedClinics() {
  ...
  const imgRefs = useRef([]); // ← parallax targets
              ...
              >
                <img
                  ...
                  style={{
                    pointerEvents: "none",
                    willChange: "transform",
                    scale: 1.15, // ← extra scale so shifted image doesn't expose card edges
                  }}
                />
