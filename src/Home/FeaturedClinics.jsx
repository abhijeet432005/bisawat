...
const clinics = [
  { id: 1, name: "Medart Hair Clinic", location: "Turkey", price: "From $1,500 – $3,750", image: "https://cdn.prod.website-files.com/6941011e592dac3331ac7edc/694ff20c591fbab7ba17de1f_Rectangle%20(5)-p-500.webp" },
...
export default function FeaturedClinics() {
  ...
  const CARD_W = containerW > 0 ? (isMobile ? containerW * 0.85 : containerW * 0.48) : 0;
  ...
  return (
    <section ref={sectionRef} className="w-full py-20 relative">
      <div className="px-6 md:px-12 mb-10">
        <h2 ref={headingRef} className="text-[#1a3a2a] text-3xl md:text-[44px] leading-tight">
          Featured Hair{" "}
          <span className="text-[#1a3a2a] font-[italic-font]">Transplant Clinics</span>
        </h2>
      </div>
            ...
            {clinics.map((clinic, i) => (
              ...
              >
                <img
                  ...
                  style={{ pointerEvents: "none", willChange: "transform", scale: 1.15 }}
                />
                <div
